...
def register_datavicmain_plugin_rules(blueprint):
    ...
    blueprint.add_url_rule('/dataset/<package_id>/nominate_view/<view_id>', view_func=nominate_view)
    blueprint.add_url_rule('/dataset/<package_id>/denominate_view/<view_id>', view_func=denominate_view)
